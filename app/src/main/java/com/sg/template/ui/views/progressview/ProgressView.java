package com.sg.template.ui.views.progressview;
...
import com.sg.template.ui.views.progressview.indicators.Indicator;
import com.sg.template.ui.views.progressview.indicators.LineSpinFadeLoaderIndicator;
...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext=context;
        init(context, attrs,0, R.style.ProgressView);
    }

    public ProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext=context;
        init(context, attrs,defStyleAttr, R.style.ProgressView);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.ProgressView_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.ProgressView_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.ProgressView_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.ProgressView_maxHeight, mMaxHeight);
        String indicatorName=a.getString(R.styleable.ProgressView_indicatorName);
        mIndicatorColor=a.getColor(R.styleable.ProgressView_indicatorColor, Color.parseColor("#067ba7"));
